...
public class UserTestCase {
	 ...
	 * address.setPostalCode("600019"); address.setBilling(true);
	 * 
	 ...
	 */
	 ...
	 /*@Test public void testAddAddress() {
	  ...
	  //attach the user to the address address.setUser(user);
...
public void testAddAddress() {
	...
	user=userDAO.getByEmail("tamilbalaji95@gmail.com");
	  ...
	  address = new Address();
	  address.setAddressLineOne("34c main road,alapuzha");
	  address.setAddressLineTwo("near Chathiram"); 
	  address.setCity("kochin");
	  address.setState("kerala");
	  address.setCountry("India");
	  address.setPostalCode("600319");
...
public void testGetAddAddress() {
	...
	assertEquals("Failed to fetch the list of address and size does not match!","Chennai",
